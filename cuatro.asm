...
.data ;SEGMENTO PARA DECLARAR VARIABLES
    ...
    resultadoMult db 0 ; VARIABLE DONDE SE DEPOSITARA EL TOTAL DE LA MULTIPLICACION
...
main PROC
    ...
    ;SEGMENTO MULTIPLICACION
    mov al,numeroUno ; MUEVE EL VALOR CAPTADO EN LA VARIABLE "numeroUno" a "AL"
    mov bl,numeroDos; MUEVE EL VALOR CAPTADO EN LA VARIABLE "numeroDos" a "BL"
    mul bl ; SE MULTIPLICA EL VALOR DE "bl" A "al"
    mov resultadoMult, al ; EL RESULTADO DE "AL" LO GUARDA EN LA VARIABLE "resultadoMult"
